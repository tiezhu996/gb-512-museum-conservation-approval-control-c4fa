...
import (
	...
	"github.com/blueship581/museum-conservation-approval-control/backend/internal/util"
...
func handleError(c *gin.Context, err error) {
	...
	case errors.Is(err, service.ErrInvalidTransition), errors.Is(err, service.ErrInvalidInput),
		errors.Is(err, service.ErrApprovalLocked), errors.Is(err, service.ErrReviewerRequired),
		errors.Is(err, service.ErrGatePlanMissing), errors.Is(err, service.ErrGateTestMissing),
		errors.Is(err, service.ErrGateSnapshotMismatch):
